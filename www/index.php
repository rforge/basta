              ...
              <tbody>
                <tr style="background:#FFFFFF">
                  <td class="main">
                    ...
                    <p class="caption" style="text-align:center">Fig. 3. Functional forms that can be tested with <b>BaSTA</b>. The general types include: a) Exponential (the name is based on the survival probability); b) Gompertz; c) Weibull; and d) logistic. Additional shapes include Makeham (green dashed lines) and bathtub (red continous lines)</p><br>
