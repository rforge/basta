												...
												<tr>
													<td align="center" valign="top" width="360">
														...
														<img alt="BaSTA photos" border="0" width="320px" align="left" style="vertical-align:top;outline-width:0px" src="BastaPhotos.jpg">
															<p align="left">&nbsp<a href="http://r-forge.r-project.org/"><br><img height="30px" src="Rforgelogo.png" border="0" alt="R-Forge Logo"></a></p>
													</td>
										...
										<table style="table-layout:fixed;background:#FFFFFF">
											<tbody>
												<tr>
													...
													<p style="text-align:center"><br><img style="margin:0px;padding:0px;border:none" width="400px" align="middle" src="Sheep.png"><br><br></p>
													...
													<p style="font-size:16px;padding-left:60px;padding-right:60px"><code style="color:#006600">&nbsp;&nbsp;&nbsp;&nbsp;install.packages("C:/Documents/BaSTAtemp/BaSTA_1.5.tar.gz", type = "source")</code><br></p>
													...
													<p class="caption">Fig. 3. Functional forms that can be tested with <b>BaSTA</b>. The general types include: a) Exponential (the name is based on the survival probability); b) Gompertz; c) Weibull; and d) logistic. Additional shapes include Makeham (green dashed lines) and bathtub (red continous lines)</p><br>
													...
													<p style="font-size:16px;padding-left:60px;padding-right:60px"><code style="color:#006600">&nbsp;&nbsp;&nbsp;&nbsp;summary(out)</code><br></p>
													<p class="parag">Which prints to the screen the relevant information such as the call of the model, the coefficients with standard errors and lower and upper bounds, if the model converged and if so, the value of model fit (DIC, which can be used for model selection; Fig. 5).<br></p>
													...
													<p class="caption">Fig. 5. BaSTA output printed by typing <code style="color:#006600">out</code> into the R console. Additional information can be obtained by typing <code style="color:#006600">summary(out)</code>.</p><br>
													<p class="parag">To plot the resulting traces for the parameters (Fig. 6), just type on the R console:<br></p>
													<p style="font-size:16px;padding-left:60px;padding-right:60px"><code style="color:#006600">&nbsp;&nbsp;&nbsp;&nbsp;plot(out)</code><br></p>
													...
													<p class="parag">And to visualize the resulting mortality and survival probability trajectories (Fig. 7), the function <code style="color:#006600">plot()</code> can be modified as:<br></p>
													<p style="font-size:16px;padding-left:60px;padding-right:60px"><code  style="color:#006600">&nbsp;&nbsp;&nbsp;&nbsp;plot(out, plot.trace = FALSE)</code><br></p>
													...
													<p class="caption">Fig. 7. Survival probability and mortality trajectories for male (M) and female (F) kestrels (<i>Falco tinnunculus</i>).</p><br>
													...
													<p class="caption">Fig. 8. Zoom in on the survival probability and mortality trajectories for male (M) and female (F) kestrels (<i>Falco tinnunculus</i>).</p><br>
													...
													<p class="parag">Additional arguments such as <code style="color:#006600">model</code> or <code style="color:#006600">shape</code> can be used to test different functional forms for the mortality functions (Fig. 3). For instance, to run a logistic model with bathtub shape for 4 simulations in parallel, the code is: <br></p>
													<p style="font-size:16px;padding-left:60px;padding-right:60px"><code style="color:#006600">&nbsp;&nbsp;&nbsp;&nbsp;out &lt;- basta(object = myDataset, studyStart = 1995, studyEnd = 2005,</code><br></p>
