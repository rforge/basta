              ...
              <tbody>
                ...
                <tr style="background:#FFFFFF">
                  <td class="main">
                    ...
                    <p class="parag"> To install the development version of <b>BaSTA</b> directly within R type: <code>install.packages("BaSTA", repos="http://R-Forge.R-project.org")</code>
<br></p>
