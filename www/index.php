										...
										<table style="table-layout:fixed;background:#FFFFFF">
											<tbody>
												<tr>
													...
													<p class="caption">Fig. 5. BaSTA output printed by typing <code style="color:#006600">out</code> into the R console. Additional information can be obtained by typing <code style="color:#006600">summary(out)</code>.</p>
