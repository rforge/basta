              ...
              <tbody>
                ...
                <tr style="background:#FFFFFF">
                  <td class="main">
                    ...
                    <p class="caption"> To install the development version of <b>BaSTA</b> directly within R type: <br><code>install.packages("BaSTA", repos="http://R-Forge.R-project.org")</code>
<br></p>
