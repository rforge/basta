          ...
          <td>
            <table style="vertical-align:middle;background:#FFFFFF" width="900px">
              <tbody>
                            ...
                            <p style="font-size:18px;line-height:1.45;text-align:justify">- BaSTA 1.9.4 available by clicking <a href="BaSTA_1.9.4.tar.gz" rel="nofollow" style="color:#84002E;font-family:verdana" target="_blank">here</a> (see installation instructions under <a href="#summary"  rel="nofollow" style="color:#84002E;font-family:verdana" target="_blank">Project Summary</a>). <br><br> - BaSTA 1.9.3 is available on CRAN.<br><br>- Check additional functions in the <a href="#extra" rel="nofollow" style="color:#84002E;font-family:verdana" target="_blank">EXTRA CODE</a> section.</p>
													</td>
												</tr>
											</tbody>
										</table>
										...
										<table style="table-layout:fixed;background:#FFFFFF">
											<tbody>
												<tr>
													...
													<p class="parag">Version 1.9.3 of the package is now availale on CRAN and can be installed by typing the following line of code into the R console: <br></p>
													...
													<p class="parag">Version 1.9.4 of the package is not yet availale on CRAN but can be downloaded by clicking <a href="BaSTA_1.9.4.tar.gz" rel="nofollow" style="color:#84002E;font-family:verdana" target="_blank">here</a>. Save the file in a folder of your choice, say ''C:/Documents/BaSTAtemp/'' for windows users, and then type on the R console:<br></p>
													<p style="font-size:16px;padding-left:60px;padding-right:60px"><code style="color:#006600">&nbsp;&nbsp;&nbsp;&nbsp;install.packages("C:/Documents/BaSTAtemp/BaSTA_1.9.4.tar.gz", </code><br></p>
													<p style="font-size:16px;padding-left:60px;padding-right:60px"><code style="color:#006600">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;type = "source")</code><br></p>
                            ...
                            <p class="parag"><a href="MultiBaSTA.R" rel="nofollow" style="color:#84002E;font-family:verdana" target="_blank"><b>MultiBaSTA()</b></a>:<br></p>
													...
													<p class="parag"><b>BaSTA 1.9.4</b> Not in CRAN yet: <br></p>
													<ul>
														<li>Fixed a bug that produced the following ''Error in FUN(newX[, i], ...) : invalid 'type' (character) of argument.'' when using covariates.</li>
													</ul>
													<p></p>
													<hr>
