        ...
        <tr align="center">
          <td>
            ...
            <table  valign="middle" width="1050px" style="table-layout:fixed;background:#DBDBDB">
              <tbody>
                <tr class="title"><th colspan="2"><p class="section">Project summary</p></th></tr>
            ...
            <table  valign="middle" width="1050px" style="table-layout:fixed;background:#DBDBDB">
              <tbody>
                <tr class="title"><th colspan="2"><p class="section">Package description</p></th></tr>
                <tr style="background:#FFFFFF">
                  <td class="main">
            ...
            <table  valign="middle" width="1050px" style="table-layout:fixed;background:#DBDBDB">
              <tbody>
                <tr class="title"><th colspan="2"><p class="section">Model description</p></th></tr>
                <tr style="background:#FFFFFF">
                  <td class="main">
            ...
            <table  valign="middle" width="1050px" style="table-layout:fixed;background:#DBDBDB">
              <tbody>
                <tr class="title"><th colspan="2"><p class="section">References</p></th></tr>
                <tr style="background:#FFFFFF">
